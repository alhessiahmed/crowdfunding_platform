...
class CreatorIdInformationScreen
    extends GetView<CreatorVerificationController> {
  const CreatorIdInformationScreen({super.key});
          ...
          children: [
            ...
            UploadCard(
              ...
              onTap: () => controller.pickImage(
                ...
                target: controller.selfieWithId,
              ),
