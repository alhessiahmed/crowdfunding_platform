...
import '../../../controller/core/routes/index.dart';
import '../../../controller/getx/controllers/auth/creator_onboarding_controller.dart';
import '../../widgets/text_field_widget.dart';
import '../../widgets/upload_card.dart';

class InstitutionIdScreen extends GetView<CreatorOnboardingController> {
  const InstitutionIdScreen({super.key});
    ...
    return SingleChildScrollView(
      child: Form(
        ...
        child: Column(
          ...
          Obx(
            () => Column(
              children: [
                ...
                _RequiredFileRow(
                  label: 'manager_id'.tr,
                  checked: controller.idImg.value != null,
                ),
                _RequiredFileRow(
          ...
          FormField<bool>(
            validator: (_) =>
                controller.hasInstitutionFiles ? null : 'Fill_required_fields'.tr,
            builder: (state) {
