            ...
            gradient: RadialGradient(
                    ...
                    child: Column(
                      children: [
                        Container( 
                          ...
                          child: SvgPicture.asset(ImagesManager.closeIcone , fit: BoxFit.scaleDown,),
                        ),
                        ...
                        Container(
                          ...
                          child: Text(
                            'حسابك غير موثق',
                            style: TextStyle( 
                              color:Get.isDarkMode ? ColorsManager.primaryTextDark: ColorsManager.primaryLight ,fontWeight: FontWeight.w700 , 
                              fontSize: 12.sp
                            ),
                          ),
                        ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: ColorsManager.grey2.withOpacity(Get.isDarkMode ?0 : .2))
                ),
                child: Row(
                  children: [
                    SizedBox(width: 6.w),
              ...
              children: [
                Text(
                  ...
                  style: Theme.of(
                    ...
                    color:Get.isDarkMode ?ColorsManager.primaryTextDark :ColorsManager.primaryLight ,
                    fontWeight: FontWeight.w700),
                ),
                SizedBox(height: 4.h),
                Text(
                  ...
                  style: Theme.of(context).textTheme.bodySmall!.copyWith(
                    color: Get.isDarkMode ? ColorsManager.secondaryDark: ColorsManager.secondaryLight,
                    fontSize: 10.sp,
                  ),
                ),
              ],
